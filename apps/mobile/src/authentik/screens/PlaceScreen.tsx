...
const makeStyles = (colors: PaletteColors) => StyleSheet.create({
  ...
  docCard: {
    ...
    height: 78,
    borderRadius: 12,
    backgroundColor: colors.placeDoc,
    borderWidth: 1,
    borderColor: `rgba(${colors.inkBaseRgb},0.2)`,
    flexDirection: "row",
    gap: 7,
    alignItems: "center",
    padding: 9,
  ...
  docLine: { height: 4, borderRadius: 2, backgroundColor: `rgba(${colors.inkBaseRgb},0.18)` },
  // Liseré blanc 1,5 px à 20 % (design v2) : sans lui, le téléphone noir disparaît sur le fond noir.
  phone: { width: 118, height: 228, borderRadius: 24, backgroundColor: "#0B0B0C", padding: 5, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.2)", shadowColor: "#0A2540", shadowOpacity: 0.24, shadowRadius: 34, shadowOffset: { width: 0, height: 16 } },
