/**
 * Commutateurs de DÉMONSTRATION (langue / scénario / réinitialisation) — transcrits depuis le
...
export function DemoControls({ demo, topInset }: { demo: AuthentikDemo; topInset: number }) {
  return (
    <View pointerEvents="box-none" style={[styles.wrap, { top: topInset + 6 }]}>
      ...
      <Pressable onPress={demo.toggleScenario} style={styles.pill}>
        <Text style={styles.pillTextMono}>{demo.scenarioLabel}</Text>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  pillTextMono: { color: "#fff", fontSize: 11, fontWeight: "600", fontFamily: "Menlo" },
});
